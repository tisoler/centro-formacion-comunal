...
const Footer = () => (
  ...
  >
    <div className="flex flex-col sm:flex-row">
      <div className="basis-2/3 bg-violeta text-white p-14 sm:pl-44">
      ...
      <div className="basis-1/3 bg-gray-200 p-14 text-center">
        ...
        <input
          type="email"
          className="my-6 w-3/4 block mx-auto bg-transparent border-0 border-b border-violeta text-violeta"
    ...
    <div className="mx-auto text-center sm:text-xs mt-6">
      ...
      <p className="font-default mb-10">
        © 2023 CFC. Desarrollado por Aillus
      </p>
    </div>
  </footer>
);
