    ...
    <div className="mx-auto relative sm:px-20 py-5">
      <div className="text-center w-full relative">
        ...
        <div className="absolute top-[40px] right-[30px] sm:top-2/4 sm:left-2/4 text-white sm:translate-y-[-50%] sm:translate-x-[-50%] font-site">
          <h2 className="sm:text-4xl mb-4">Público y de calidad</h2>
          <h1 className="sm:text-[90px] sm:leading-[90px]">
            Educación para todos
          </h1>
        </div>
        <div className="flex flex-col sm:flex-row relative items-center bg-white mt-[-10px] sm:mt-[-55px] mx-auto max-w-xs sm:max-w-4xl border-t-4 border-violeta font-site">
          <h3 className="flex-1 sm:text-3xl py-4 px-8 text-center sm:text-left">
            Muchas opciones esperando por vos
          </h3>
          <a
            href="/cursos"
      ...
      >
        <div className="basis-1/3">
          ...
          <div className="border-y-4 border-violeta p-8 sm:w-60 relative bg-white sm:mt-[-300px]">
        ...
        <div className="basis-2/3">
          ...
          <div className="border-y-4 border-violeta p-8 sm:w-60 relative bg-white sm:ml-32 sm:mt-[-430px]">
            <h3 className="text-2xl font-site">Nuestra misión</h3>
            <p className="my-6 text-sm text-justify">
              Este proyecto busca ser un puente entre la universidad y el mundo del 
              trabajo, escuchando las demandas sociales y del sector productivo. 
              Surge desde Máximo Paz y cuenta con un alcance regional, busca 
              promover la formación laboral y profesional de jóvenes en oficios 
              acercando la Universidad a los pueblos del interior.
            </p>
            <a href="/sobrenosotros" className="text-purple-site py-6 font-site">
              Saber más
            </a>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:mt-32 mb-12 sm:gap-12">
        <div className="basis-2/3">
          ...
          <div className="border-y-4 border-violeta p-8 sm:w-60 relative bg-white sm:ml-44 sm:mt-[-230px]">
        ...
        <div className="basis-1/3">
          ...
          <div className="border-y-4 border-violeta p-8 sm:w-60 relative bg-white sm:ml-32 sm:mt-[-530px]">
      ...
      <div className="flex flex-col sm:flex-row gap-8 sm:justify-between items-center font-site w-full">
        <div className='w-4/12 flex justify-center sm:justify-start'>
          <div className="relative text-center sm:text-left w-fit">
        ...
        <div className='w-4/12 flex justify-center'>
          <div className="relative text-center sm:text-left w-fit">
            ...
            <span className="border-t-4 block sm:inline-block border-purple-site text-xl sm:text-4xl sm:absolute sm:top-[82px] sm:left-[50px] bg-white">
              Universidades
              <br />
              conectadas
            </span>
        ...
        <div className='w-4/12 flex justify-center'>
          <div className="relative text-center sm:text-left">
            ...
            <span className="border-t-4 block sm:inline-block border-purple-site text-xl sm:text-4xl sm:absolute sm:top-[130px] sm:left-[50px] bg-white">
              Cursos
              <br />
              presenciales
            </span>
